...
@section('container')
                ...
                <br>
                <h5 class="h5 mb-2 text-gray-800 font-weight-bold">7 Cluster RFM Scores</h5>
                ...
                {!! file_get_contents(public_path('content/cust_seg/4. SILHOUETTE 3 5 7/1. Cluster Silhouette Cooefficient/centers.html')) !!}
